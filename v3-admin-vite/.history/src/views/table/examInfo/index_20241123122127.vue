...
const getTableData = () => {
  loading.value = true
  getExamInfoList({ page: paginationData.page, size: paginationData.size })
    .then((res: any) => {
      console.log("res", res)
    ...
    <el-dialog v-model="dialogVisible" :title="modalTitle" @close="resetForm" width="30%">
      <el-form ref="formRef" :model="formData" :rules="rules" label-width="160px" label-position="left">
        ...
        <el-row style="margin-bottom: 10px">
          ...
          <el-col :span="6"
            ><el-button :icon="CirclePlus" @click="addTableItem('examIntroduction')">添加项目</el-button></el-col
          >
        </el-row>
        <div v-for="(item, index) in formData.examInfoContent.examIntroduction">
          <el-form-item prop="title" :label="'简介标题' + (index + 1)">
            <el-row>
              <el-col :span="index > 0 ? 16 : 24"><el-input v-model="item.title" placeholder="请输入标题" /></el-col>
              <el-col :span="8" v-if="index > 0"
                ><el-button :icon="CirclePlus" @click="removeTableItem('examIntroduction', index)"
                  >删除项目</el-button
                ></el-col
              >
            </el-row>
        ...
        <el-row style="margin-bottom: 10px">
          ...
          <el-col :span="6"
            ><el-button :icon="CirclePlus" @click="addTableItem('examGuid')">添加项目</el-button></el-col
          >
        </el-row>
        <div v-for="(item, index) in formData.examInfoContent.examGuid">
          <el-form-item prop="title" :label="'简介标题' + (index + 1)">
            <el-row>
              <el-col :span="index > 0 ? 16 : 24"><el-input v-model="item.title" placeholder="请输入标题" /></el-col>
              <el-col :span="8" v-if="index > 0"
                ><el-button :icon="CirclePlus" @click="removeTableItem('examGuid', index)">删除项目</el-button></el-col
              >
            </el-row>
          </el-form-item>
          <el-form-item prop="orgName" :label="'消息内容' + (index + 1)">
        ...
        <el-row style="margin-bottom: 10px">
          ...
          <el-col :span="6"
            ><el-button :icon="CirclePlus" @click="addTableItem('examScope')">添加项目</el-button></el-col
          >
        </el-row>
        <div v-for="(item, index) in formData.examInfoContent.examScope">
          <el-form-item prop="title" :label="'简介标题' + (index + 1)">
            <el-row>
              <el-col :span="index > 0 ? 16 : 24"><el-input v-model="item.title" placeholder="请输入标题" /></el-col>
              <el-col :span="8" v-if="index > 0"
                ><el-button :icon="CirclePlus" @click="removeTableItem('examScope', index)">删除项目</el-button></el-col
              >
            </el-row>
          </el-form-item>
          <el-form-item prop="orgName" :label="'消息内容' + (index + 1)">
        ...
        <el-row style="margin-bottom: 10px">
          ...
          <el-col :span="6"
            ><el-button :icon="CirclePlus" @click="addTableItem('examArrangements')">添加项目</el-button></el-col
          >
        </el-row>
        <div v-for="(item, index) in formData.examInfoContent.examArrangements">
          <el-form-item prop="title" :label="'简介标题' + (index + 1)">
            <el-row>
              <el-col :span="index > 0 ? 16 : 24"><el-input v-model="item.title" placeholder="请输入标题" /></el-col>
              <el-col :span="8" v-if="index > 0"
                ><el-button :icon="CirclePlus" @click="removeTableItem('examArrangements', index)"
                  >删除项目</el-button
                ></el-col
              >
            </el-row>
        ...
        <el-row style="margin-bottom: 10px">
          ...
          <el-col :span="6"
            ><el-button :icon="CirclePlus" @click="addTableItem('examCertificate')">添加项目</el-button></el-col
          >
        </el-row>
        <div v-for="(item, index) in formData.examInfoContent.examCertificate">
          <el-form-item prop="title" :label="'简介标题' + (index + 1)">
            <el-row>
              <el-col :span="index > 0 ? 16 : 24"><el-input v-model="item.title" placeholder="请输入标题" /></el-col>
              <el-col :span="8" v-if="index > 0"
                ><el-button :icon="CirclePlus" @click="removeTableItem('examCertificate', index)"
                  >删除项目</el-button
                ></el-col
              >
            </el-row>
        ...
        <el-row style="margin-bottom: 10px">
          ...
          <el-col :span="6"
            ><el-button :icon="CirclePlus" @click="addTableItem('examInformation')">添加项目</el-button></el-col
          >
        </el-row>
        <div v-for="(item, index) in formData.examInfoContent.examInformation">
          <el-form-item prop="title" :label="'简介标题' + (index + 1)">
            <el-row>
              <el-col :span="index > 0 ? 16 : 24"><el-input v-model="item.title" placeholder="请输入标题" /></el-col>
              <el-col :span="8" v-if="index > 0"
                ><el-button :icon="CirclePlus" @click="removeTableItem('examInformation', index)"
                  >删除项目</el-button
                ></el-col
              >
            </el-row>

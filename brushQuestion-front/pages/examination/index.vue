<template>
	<view class="container">
        ...
        <uni-row class="uni-row">
					...
					<uni-col :span="8">
						<uni-forms-item name="cpn">
							<uni-easyinput :clearable="false" type="number" v-model="formData.cpn" />
						</uni-forms-item>
					</uni-col>
					<uni-col :span="8">
						<uni-forms-item name="cpnScore">
							<uni-easyinput :clearable="false" type="number" v-model="formData.cpnScore" />
						</uni-forms-item>
					</uni-col>
				</uni-row>
        <uni-row class="uni-row">
					...
					<uni-col :span="8">
						<uni-forms-item name="saq">
							<uni-easyinput :clearable="false" type="number" v-model="formData.saq" />
						</uni-forms-item>
					</uni-col>
					<uni-col :span="8">
						<uni-forms-item name="saqScore">
							<uni-easyinput :clearable="false" type="number" v-model="formData.saqScore" />
						</uni-forms-item>
					</uni-col>
				</uni-row>

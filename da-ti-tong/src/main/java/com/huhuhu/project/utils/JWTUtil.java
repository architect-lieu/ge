...
public class JWTUtil {
    // 生成签名是所使用的秘钥
    private static final String BASE64_ENCODED_SECRET_KEY = "b421fdbef854ad0b1a231d23b6bbd88f7f27af01";
     ...
     */
    public static String createToken(String iss, long ttlMillis, Map<String, Object> claims) {
        if (claims == null) {
            claims = new HashMap<>();
        }
     ...
     */
    public static void isVerify(String jwtToken) {
        Algorithm algorithm;
